...
const en_reviews_title = /** @type {(inputs: {}) => string} */ () => {
	return `What our customers say`
};

const de_reviews_title = /** @type {(inputs: {}) => string} */ () => {
	return `Was unsere Kunden sagen`
};

const it_reviews_title = /** @type {(inputs: {}) => string} */ () => {
...
export const reviews_title = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_reviews_title(inputs)
	if (locale === "de") return de_reviews_title(inputs)
	return it_reviews_title(inputs)
};
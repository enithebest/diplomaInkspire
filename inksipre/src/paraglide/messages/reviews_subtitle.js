...
const en_reviews_subtitle = /** @type {(inputs: {}) => string} */ () => {
	return `Real words from happy creators`
};

const de_reviews_subtitle = /** @type {(inputs: {}) => string} */ () => {
	return `Echte Worte von zufriedenen Kreativen`
};

const it_reviews_subtitle = /** @type {(inputs: {}) => string} */ () => {
...
export const reviews_subtitle = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_reviews_subtitle(inputs)
	if (locale === "de") return de_reviews_subtitle(inputs)
	return it_reviews_subtitle(inputs)
};
...
const en_nav_contact = /** @type {(inputs: {}) => string} */ () => {
	return `Contact`
};

const de_nav_contact = /** @type {(inputs: {}) => string} */ () => {
	return `Kontakt`
};

const it_nav_contact = /** @type {(inputs: {}) => string} */ () => {
	return `Contatti`
};
...
export const nav_contact = (inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_nav_contact(inputs)
	return it_nav_contact(inputs)
};
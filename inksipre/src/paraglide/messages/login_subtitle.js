...
const en_login_subtitle = /** @type {(inputs: {}) => string} */ () => {
	return `Secure access to your account`
};

const de_login_subtitle = /** @type {(inputs: {}) => string} */ () => {
	return `Sicherer Zugriff auf Ihr Konto`
};

const it_login_subtitle = /** @type {(inputs: {}) => string} */ () => {
...
export const login_subtitle = (inputs = {}, options = {}) => {
	...
	if (locale === "de") return de_login_subtitle(inputs)
	return it_login_subtitle(inputs)
};
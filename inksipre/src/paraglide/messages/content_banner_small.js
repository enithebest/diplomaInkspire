...
const en_content_banner_small = /** @type {(inputs: {}) => string} */ () => {
	return `Bring Your Designs to Life`
};

const de_content_banner_small = /** @type {(inputs: {}) => string} */ () => {
	return `Bringen Sie Ihre Designs zum Leben`
};

const it_content_banner_small = /** @type {(inputs: {}) => string} */ () => {
...
export const content_banner_small = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_content_banner_small(inputs)
	if (locale === "de") return de_content_banner_small(inputs)
	return it_content_banner_small(inputs)
};
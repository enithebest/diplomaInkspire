  ...
  <form method="POST" action="?/search" use:enhance class="flex flex-col sm:flex-row gap-3 justify-center mb-12">
    <div class="relative w-full sm:w-1/2">
      <input
        ...
        class="border border-gray-700 bg-gray-800 text-gray-200 placeholder:text-gray-400 rounded-lg px-4 py-2 w-full pr-10 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition"
        required
...
{:else if product.image_url}
  ...
  />
{:else}
  <span class="text-gray-300 text-sm">Image coming soon</span>
{/if}
            ...
            <div class="mt-3 flex-1 flex flex-col gap-2">
              ...
              {#if product.description}
                <p class="text-gray-300 text-sm line-clamp-2">{short(product.description, 110)}</p>
              {/if}

...
export const contact_badge = /** @type {(inputs: {}) => string} */ () => {
	return `Rispondiamo entro 24h`
};
export const contact_title = /** @type {(inputs: {}) => string} */ () => {
	return `Contatta`
};
export const contact_intro = /** @type {(inputs: {}) => string} */ () => {
	return `Serve un preventivo, aiuto sul design o supporto? Chiamaci, vieni a trovarci o inviaci un messaggio e risponderemo subito.`
};
...
export const contact_highlight_fast_desc = /** @type {(inputs: {}) => string} */ () => {
	return `Tempo medio di risposta sotto le 24h`
};
